...
public class redirSetPageTest {
    ...
    public void getBills() {
        AssembledData.bulkRequestInterface(ParamUtil.getProfile(path),"getBills",host, httpHeaders.riderAppHeader());
    }

    @Test
    public void getSch() {
        AssembledData.bulkRequestInterface(ParamUtil.getProfile(path),"getSch",host, httpHeaders.riderAppHeader());
    }
}