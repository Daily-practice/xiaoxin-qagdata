...
public class redirSetPageTest {
    ...
    public void queryHistroyOrder() {
        Assert.assertEquals(ResponseUtil.getOneKeyValue(rsp.bulkRequestInterface(ParamUtil.getProfile(path),"queryHistroyOrder",host, httpHeaders.riderAppHeader()),"msg"),"1");
    }
